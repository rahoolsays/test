        ...
        <td style="padding:20px;border-bottom:1px solid#f0f0f5;border-color:rgba(201,201,207,.35);">
          ...
          <img src="https://i.ibb.co/NTH5s1G/logo-blue.jpg" alt="logo-blue" style="width:240px;">
              ...
              <div style="padding:30px;">
                ...
                <p style="margin-top:0;margin-bottom:20px;">Thanks for taking your time and filling out all data.</p>
                <p style="margin-top:0;margin-bottom:18px;">
                  Our team will review it and will get back to you on further process soon.
                </p>

                <p style="margin-top:0;margin-bottom:18px;">
                  Hope to see you soon in Simpaisa Family.
                </p>
