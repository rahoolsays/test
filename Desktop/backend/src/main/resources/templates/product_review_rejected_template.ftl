        ...
        <td style="padding:20px;border-bottom:1px solid#f0f0f5;border-color:rgba(201,201,207,.35);">
          ...
          <img src="https://i.ibb.co/NTH5s1G/logo-blue.jpg" alt="logo-blue" style="width:240px;">
              ...
              <div style="padding:30px;">
                ...
                <p style="margin-top:0;margin-bottom:18px;">
                  After detailed review  of information provided by you about product (PRODUCT ID: ${productID}) for being live with simpaisa, we are sorry say we can not got live your product right now.
                ...
                <p style="margin-top:0;margin-bottom:18px;">
                     ...
                     Please note that your Product form is editable again.
                 </p>
                  <p style="margin-top:0;margin-bottom:18px;">
                  ${rejectionReason}
                  </p>
